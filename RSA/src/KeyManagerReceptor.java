...
public class KeyManagerReceptor {
    private static final String PUBLIC_KEY_FILE = "src\\public_key_receptor.key";
    private static final String PRIVATE_KEY_FILE = "src\\private_key_receptor.key";
